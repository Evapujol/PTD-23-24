...
// Como result está declarada antes, no hace falta volver a declarar
...
// result = num1 % num2; 
// console.log (" el resto de la division vale " + result);

// num1++;
// console.log (" después del incremento de num1 el resltado vale " + result);
